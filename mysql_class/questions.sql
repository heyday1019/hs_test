...
FROM tb_customer
WHERE TOTAL_POINT >= 20000 AND MW_FLG = 'M' AND BIRTH_DAY LIKE '198%'
;
-- 연습문제 9. LIKE
...
SELECT *
FROM tb_customer
-- WHERE MW_FLG = 'M' AND (BIRTH_DAY LIKE '%05%' OR BIRTH_DAY LIKE '%06%' OR BIRTH_DAY LIKE '%07%') 
WHERE MW_FLG = 'M' AND REGEXP_Like (BIRTH_DAY, '____05__|____06__|____07__') 
;
-- 연습문제 10. LIKE
